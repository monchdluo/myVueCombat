    ...
    <div class="list_content">
      <div class="list_swiper">
        <van-swipe class="my-swipe swppp" :autoplay="3000" indicator-color="white">
          <van-swipe-item>
            <div><img src="../images/swiper/swiper1.webp" alt=""></div>

          </van-swipe-item>
          <van-swipe-item>
            <div><img src="../images/swiper/swiper2.webp" alt=""></div>

          </van-swipe-item>
          <van-swipe-item>
            <div><img src="../images/swiper/swiper3.webp" alt=""></div>

          </van-swipe-item>
          <van-swipe-item>
            <div><img src="../images/swiper/swiper4.webp" alt=""></div>
